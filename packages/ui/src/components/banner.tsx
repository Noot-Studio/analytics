...
import { useLazyRef } from "@sbox-analytics/ui/hooks/use-lazy-ref";
...
function BannerClose(props: React.ComponentProps<typeof Button>) {
  ...
  // Matches the project Button's onClick event type (Base UI augments the
  // React mouse event), which the upstream diceui code didn't account for.
