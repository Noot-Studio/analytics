...
import { useComposedRefs } from "@sbox-analytics/ui/lib/compose-refs";
import { cn } from "@sbox-analytics/ui/lib/utils";
import { useAsRef } from "@sbox-analytics/ui/hooks/use-as-ref";
import { useIsomorphicLayoutEffect } from "@sbox-analytics/ui/hooks/use-isomorphic-layout-effect";
...
type ButtonEvent<K extends "onClick" | "onFocus" | "onKeyDown" | "onMouseDown"> =
  Parameters<NonNullable<React.ComponentProps<typeof Button>[K]>>[0];
