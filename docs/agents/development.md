...
Architectural decisions and their trade-offs live as ADRs in `docs/adr/`.

## Tech Stack

| Layer             | Choice                                                              | Rationale                                                                                                                  |
| ----------------- | ------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Platform Scaffold | [better-t-stack](https://github.com/michaelangeloio/better-t-stack) | Monorepo configured for Hono + oRPC + TanStack Router + React + Better Auth + Prisma + Polar — rapid, type-safe foundation |
...
| Documentation     | Fumadocs (`apps/fumadocs`)                                          | API reference, SDK guides, and tutorials                                                                                   |
